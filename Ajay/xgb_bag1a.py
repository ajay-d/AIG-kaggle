...
train = pd.read_csv('train_recode_3.csv.gz', compression="gzip")
test = pd.read_csv('test_recode_3.csv.gz', compression="gzip")
train.shape
test.shape
...
df.to_csv('gbm_bag_m1a_d15.csv.gz', index = False, compression='gzip')
