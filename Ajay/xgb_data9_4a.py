...
train = pd.read_csv('train_recode_9.csv.gz', compression="gzip")
test = pd.read_csv('test_recode_9.csv.gz', compression="gzip")
train.shape
test.shape
...
df.to_csv('gbm_m4a_data9.csv.gz', index = False, compression='gzip')