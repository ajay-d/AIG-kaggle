create.dataset.all <- function(train.test){
  ...
  train.test <- select(train.test,
                       ...
                       cat_state,
                       cat_icd9,cat_major_code,cat_occ,cat_suit_type,
                       cat_law_tt,cat_law_pt,cat_law_pp,
                       law_limit_tt_int,law_limit_pt_int,law_limit_pp_int,
                       cat_cas_34,cat_clm_12,cat_clm_34,
                       cat_cas_1234,cat_cas_12,
                       cat_clm_1234,
                       cat_cas_clm_12,cat_cas_clm_34,cat_cas_12_clm_34,cat_cas_34_clm_12,
                       cat_state_age,cat_gender_loss_age,
                       cat_gender_age,
                       cat_state_wage,cat_state_adj,
                       cat_suit_year,cat_create_year,cat_loss_year,
                       cat_state_loss,
                       
                       cat_suit_year_type,cat_state_suit_type,
                       cat_state_eff_year,cat_state_clm_34,cat_cutoff_last_year,
                       first_after_loss,cat_loss_year_first_year,
                       cat_major_cd_suit_year,
                       cat_state_clm_12,cat_state_cas_12,cat_state_suit_year,cat_suit_type_clm_3_4,
                       cat_suit_type_cas_1_2,cat_suit_type_clm_1_2,cat_suit_year_cas_1_2,cat_suit_year_clm_1_2,
                       cat_suit_year_clm_3_4,cat_init_code_clm_3_4,cat_cutoff_loss_year,
                       cat_major_cd_state,cat_major_cd_suit_type,cat_major_cd_clm_12,cat_major_cd_clm_34,cat_law_ib_scheduled_clm_12,
