...
dataset_blend_train_xgb1.to_pickle('FEAT4_LVL1_XGB1_TRAIN_CV_' + str(scores_mean) + '_.pkl')
dataset_blend_test_xgb1.to_pickle('FEAT4_LVL1_XGB1_TEST_CV_'+ str(scores_mean) + '_.pkl')   
...
dataset_blend_train.to_pickle('FEAT4_LVL1_RF1_BAG10_TRAIN_CV_' + str(np.mean(bag_score))+ '_.pkl')
dataset_blend_test.to_pickle('FEAT4_LVL1_RF1_BAG10_TEST_CV_' + str(np.mean(bag_score)) + '_.pkl')#without econ_unemployment_py
