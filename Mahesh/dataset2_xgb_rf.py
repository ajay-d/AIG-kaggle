...
dataset_blend_train_xgb1.to_pickle('XGB1_lvl1_feat2_TRAIN_CV_' + str(scores_mean) + '_.pkl')
dataset_blend_test_xgb1.to_pickle('XGB1_lvl1_feat2_TEST_CV_'+ str(scores_mean) + '_.pkl')   
    
print ("Done with XGB_1------>")



#BAGGING 10 RF - LVL1 - FEAT2 ------ MODIFY CODE TO BAG THIS RF 40 times
from sklearn.ensemble import RandomForestClassifier
...
dataset_blend_train.to_pickle('RF4_LVL1_FEAT2_BAG10_TRAIN_CV_' + str(np.mean(bag_score))+ '_.pkl')
dataset_blend_test.to_pickle('RF4_LVL1_FEAT2_BAG10_TEST_CV_' + str(np.mean(bag_score)) + '_.pkl')#without econ_unemployment_py
