...
foo2count = ['diagnosis_icd9_cd','occ_desc1'] #, 'cas_aia_cds_1_2', 'clm_aia_cds_1_2', 'diagnosis_icd9_cd', 
       #'clm_aia_cds_3_4',  'sic_cd', 'occ_code', 'occ_desc1', 'occ_desc2' 'sic_cd', 'occ_code', , 'occ_desc2''diagnosis_icd9_cd', ]
...
data = data[['econ_unemployment_py', 'diagnosis_icd9_cd', 'slice', 'aww1',
       ...
       'm26', 'm28', 'mfc', 'mm2', 'mm6', 'mmo', 'mmq', 'mmw', 'mp8', 'mtf', 'label',
            
            'law_limit_pp']]

col2dummy= ['initl_trtmt_cd', 'catas_or_jntcvg_cd', 'state', 'suit_matter_type',
            'law_cola','law_offsets', 'law_ib_scheduled', 'clmnt_gender',
            'cas_aia_cds_1_2', 'clm_aia_cds_1_2','clm_aia_cds_3_4', 'law_limit_tt', 'law_limit_pt','adj_prev' , 
            
            'law_limit_pp'] # 'slice', 'cutoffyr_flag',,'lp1'

data = pd.get_dummies(data, columns = col2dummy, sparse = False)
...
labels = train['label']
train.drop(['label'], inplace = True, axis = 1) #'claim_id','paid_year',
final_test.drop(['label'], inplace = True, axis = 1) #'claim_id',
...
if feature_selection == 1:
    ...
    feat_test = feat_imp[feat_imp.index.values > 0.0005]  #0.001
    feat_test = feat_test.reset_index()
    feat_test.drop('index', inplace = True, axis = 1)

    train_foo = train[feat_test[0].values]
...
train_foo = train[['econ_unemployment_py', 'diagnosis_icd9_cd', 'slice', 'aww1',
       ...
       'diff_paid_impmt', 'diff_paid_mmi', 'diff_paid_death',
       'diff_paid_return', 'diff_paid_suit', 'age_claimaint',
       'target_prev', 'cutoffyr_flag', 'target_median3', 'lp1', 'i_prev',
       'm_prev', 'tpd_amt', 'l_prev', 'i_prev_avg3', 'm_prev_avg3', 'i02',
       'i04', 'i05', 'i06', 'i18', 'l24', 'l72', 'l79', 'ldl', 'lf2',
       'll1', 'll6', 'lpc', 'lpw', 'lu7', 'm25', 'm26', 'm28', 'mfc',
       'mm2', 'mm6', 'mmo', 'mmq', 'mmw', 'mp8', 'mtf',
       'initl_trtmt_cd_0.0', 'initl_trtmt_cd_2.0', 'initl_trtmt_cd_3.0',
       'initl_trtmt_cd_5.0', 'catas_or_jntcvg_cd_N', 'state_CA',
       'state_IL', 'state_KY', 'state_NJ', 'state_NY', 'state_TX',
       'suit_matter_type_0', 'suit_matter_type_01', 'suit_matter_type_06',
       'law_cola_no', 'law_cola_yes', 'law_offsets_no', 'law_offsets_yes',
       'law_ib_scheduled_no', 'law_ib_scheduled_yes', 'clmnt_gender_F',
       'clmnt_gender_M', 'cas_aia_cds_1_2_1E', 'cas_aia_cds_1_2_CI',
       'cas_aia_cds_1_2_LI', 'cas_aia_cds_1_2_MO', 'cas_aia_cds_1_2_PS',
       'clm_aia_cds_1_2_1P', 'clm_aia_cds_1_2_DI', 'clm_aia_cds_1_2_KN',
       'clm_aia_cds_1_2_LB', 'clm_aia_cds_1_2_LU', 'clm_aia_cds_1_2_MB',
       'clm_aia_cds_1_2_SH', 'clm_aia_cds_3_4_BL', 'clm_aia_cds_3_4_CR',
       'clm_aia_cds_3_4_DL', 'clm_aia_cds_3_4_FR', 'clm_aia_cds_3_4_RT',
       'clm_aia_cds_3_4_SP', 'clm_aia_cds_3_4_ST', 'law_limit_tt_104',
       'law_limit_tt_400', 'law_limit_tt_disability', 'law_limit_pt_500',
       'law_limit_pt_600', 'law_limit_pt_disability', 'law_limit_pt_life',
       'law_limit_pt_retirement', 'adj_prev_Other', 'adj_prev_PPD',
       'adj_prev_PTD', 'adj_prev_STLMT', 'adj_prev_TTD']]
...
clf= RandomForestClassifier(n_estimators=3000, max_depth = 20, min_samples_leaf = 2, n_jobs=-1, verbose=True,
...
train_foo.columns.shape

train_foo.to_pickle("feat4_train.pkl")
final_test_foo.to_pickle("feat4_test.pkl")